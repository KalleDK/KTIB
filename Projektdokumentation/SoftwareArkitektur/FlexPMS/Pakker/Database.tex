...
{
\funkArg{type}{Sensor type ID. Se Tabel \ref{fig:karSensorData_kol} for mulige værdier}
...
{
\funkArg{type}{Sensor type ID. Se Tabel \ref{fig:oeSensorData_kol} for mulige værdier}
\funkArg{value}{Den målte værdi}
}
