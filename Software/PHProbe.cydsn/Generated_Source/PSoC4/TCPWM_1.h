...
#define TCPWM_1_TC_PRESCALER                   (7lu)
...
/* Interrupt Mask */
#define TCPWM_1_TC_INTERRUPT_MASK              (2lu)
...
/* Timer/Counter Mode */
#define TCPWM_1_TC_PERIOD_VALUE                (20925lu)
#define TCPWM_1_TC_COMPARE_VALUE               (20924lu)
#define TCPWM_1_TC_COMPARE_BUF_VALUE           (0lu)
