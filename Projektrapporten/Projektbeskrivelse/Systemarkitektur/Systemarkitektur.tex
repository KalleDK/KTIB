...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.82\textwidth]{Projektbeskrivelse/Systemarkitektur/photo/System_BDD}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.82\textwidth]{Projektbeskrivelse/Systemarkitektur/photo/System_Allokeringsdiagram}
